...
//    private float textActiveSize = 16f;
...
//    }
//
//    public void setWidtItem(int resdime) {
//        widthItem = mResources
//                .getDimensionPixelSize(resdime);
//    }
//
...
//                        + widthItem + "/ " + tabsContainer.getHeight() + "/ " + widthFirst + "/ " + widthLast);
